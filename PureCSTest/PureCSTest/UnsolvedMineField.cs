...
namespace Minesweeper
{
    public class UnsolvedMineField : IUnsolvedMineField
    {
        ...
        public UnsolvedMineField(int seed, int sizeX, int sizeY, int mines)
        {
            ...
            OpenedSquares = new sbyte[sizeX, sizeY];
            OpenedSquares.Fill((sbyte)-1);
        }
        public UnsolvedMineField(int[,] numbers)
            : this(numbers.Select(i=>(sbyte)i)) { }
        public UnsolvedMineField(sbyte[,] numbers)
        {
            Numbers = numbers;
            MineCount = Numbers.AsEnumerable().Count(i => i == 9);
            OpenedSquares = new sbyte[GetSizeX(), GetSizeY()];
            OpenedSquares.Fill((sbyte)-1);
        }
        ...
        public sbyte[,] RevealedNumbers() => OpenedSquares;
